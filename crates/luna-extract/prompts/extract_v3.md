...
| manuscript   | character_identity  | a manuscript character identity, role, or stable title    | `"Mara Vey is the captain of the Tidefall"`         |
| manuscript   | character_alias     | a manuscript character alias, nickname, or called-name    | `"Mara Vey is called the Glass Finch"`              |
| manuscript   | scene_order         | the order in which manuscript scenes appear               | `"scene:1 appears_before scene:2"`                  |
| manuscript   | story_chronology    | story-time ordering that differs from scene order         | `"scene:2 occurs_before scene:1"`                   |
| manuscript   | event_fact          | a scene-bound manuscript event with story-time label      | `"scene:1 story_time:present Mara Vey carries the Tidefall chart"` |
| manuscript   | open_arc            | an unresolved manuscript plot or continuity arc           | `"Tidefall chart location unresolved"`              |
