...
use crate::{
    ...
    llm_observation::{validate_against_prompt_v1, LlmObservation, EXTRACTION_SCHEMA_VERSION},
    prompt::{build_prompt_v1, prompt_v1_hash},
};
...
impl<B: LlmBackend, C: ExtractionCache> LlmExtractor<B, C> {
    ...
    pub fn extract(&self, turn: &ConversationTurn) -> Result<LlmObservation> {
        ...
        let violations = validate_against_prompt_v1(&observation);
...
mod tests {
    ...
    fn well_formed_response() -> String {
        // Hand-crafted to satisfy validate_against_prompt_v1: valid
    ...
    fn invalid_domain_response() -> String {
        ...
        // serde parsing, fails validate_against_prompt_v1.
        let observation = LlmObservation {
            assertions: vec![LlmAssertion {
