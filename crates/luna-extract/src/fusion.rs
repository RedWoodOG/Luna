...
//! [`luna_core::TurnReading`] that recall reads.
//!
...
/// final [`TurnReading`]. See module docs for the rules.
pub fn fuse_observation(
    ...
    // because TurnReading requires it.
...
mod tests {
    ...
    fn detectors_never_create_assertions() {
        ...
        // TurnReading. Detectors are signal-only.
        let llm_obs = LlmObservation {
            assertions: vec![],
            signals: empty_signals(),
        };
