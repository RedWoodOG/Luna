...
pub trait FeatureExtractor {
    fn extract(&self, turn: &ConversationTurn) -> Result<TurnReading>;
}
...
pub fn fuse_observations(observations: &[TurnReading]) -> TurnReading {
...
fn fuse_dimension(
    observations: &[TurnReading],
    read: impl Fn(&TurnReading) -> Option<Signal>,
) -> Option<Signal> {
