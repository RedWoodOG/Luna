...
as a group. In Milestone 0, orbs are documented but not implemented.
...
A future topology evolution where an unstable dense orb divides into smaller
...
may add assertion ids, orb ids, compression ids, or mutation event ids.
