...
- Contradiction pressure rising inside an orb.
- Retrieval precision dropping as orb density rises.
...
- Replay a suspect orb lineage after sentinel pressure rises.
